...
用户可以在**MindMeet**中创建自己或加入他人的“小队”，共同追逐目标，相互监督成长

**功能描述**

+ 用户可以在**MindMeet**中创建、编辑和删除自己的小队。
+ 小队必须包含至少一个共同的目标计划，且所有人可以将其共享入自己的日程表中。
+ 加入小队的各个成员可以互相看到对方的完成或执行情况，达到互相激励和监督。
+ 必要时，小队中可以加入“奖励”来进一步激励、鼓励成员。

**用例场景**

1. 用户登录到**MindMeet**软件中。
2. 用户进入“社交”选项卡，再进入“目标挑战”页面。
3. 用户可以设置目标计划并创建小队，或加入别人小队共享目标计划

4. 手动处理目标计划的冲突

#### 3.3.6 共享安排

用户可以在**MindMeet**中获取别人分享的日程表安排，并进一步导入自己的日程表

**功能描述**

+ 用户可以在**MindMeet**中看到并获取别人的日程表安排。
+ 用户可以通过导入并体验他人的日程表安排来进一步学习经验。
...
1. 用户登录到**MindMeet**软件中。
2. 用户进入“社交”选项卡，并进入“规划共享”页面。
3. 用户选择符合自己的吉特自学安排，并进行添加。
4. 发生日程表冲突时，用户可以手动进行具体时间调整。

#### 3.3.7 参与社区

用户可以在**MindMeet**中参与自己的兴趣社区
